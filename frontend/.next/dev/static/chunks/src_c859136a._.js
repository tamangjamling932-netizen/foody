...
function ProductDetailPage() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "ProductDetailPage.useEffect": ()=>{
            if (!params.id) return;
            const fetchReviews = {
                "ProductDetailPage.useEffect.fetchReviews": async ()=>{
                    try {
                        const res = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].get(`/reviews/product/${params.id}`);
                        setReviews(res.data.reviews || []);
                        // Check if user already reviewed
                        if (user) {
                            const existing = (res.data.reviews || []).find({
                                "ProductDetailPage.useEffect.fetchReviews.existing": (r)=>{
                                    const reviewUser = typeof r.user === 'object' ? r.user._id : r.user;
                                    return reviewUser === user._id;
                                }
                            }["ProductDetailPage.useEffect.fetchReviews.existing"]);
                            if (existing) setMyReview(existing);
                        }
                    } catch  {}
                    setReviewsLoading(false);
                }
            }["ProductDetailPage.useEffect.fetchReviews"];
            fetchReviews();
                    ...
                    "ProductDetailPage.useEffect": (res)=>{
                        ...
                        const hasCompleted = orders.some({
                            "ProductDetailPage.useEffect.hasCompleted": (o)=>[
                                    ...
                                    "ProductDetailPage.useEffect.hasCompleted": (i)=>i.product === params.id
    ...
    const onReviewSubmit = async (data)=>{
        ...
        try {
            ...
            const res = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].post(`/reviews/product/${params.id}`, {
            ...
            const prodRes = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].get(`/products/${params.id}`);
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    ...
                    user && canReview && !myReview && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        className: "mb-8 border border-gray-100 rounded-lg p-5 bg-gray-50",
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("h3", {
                                        ...
                                        children: [
                                            [
                                                ...
                                                5
                                                    ...
                                                    children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$icons$2f$fi$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["FiStar"], {
                                                        size: 24,
                                                        className: `transition-colors ${star <= (hoverRating || selectedRating) ? 'fill-yellow-400 text-yellow-400' : 'text-gray-300'}`
                                                    }, void 0, false, {
                                                        fileName: "[project]/src/app/(dashboard)/(customer)/menu/[id]/page.tsx",
                                                        lineNumber: 394,
                                                        columnNumber: 21
                    ...
                    myReview && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        className: "mb-6 border border-[var(--primary)]/20 rounded-lg p-4 bg-[var(--primary)]/5",
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    reviewsLoading ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        lineNumber: 449,
                        columnNumber: 11
                    }, this) : reviews.length === 0 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
...
_s(ProductDetailPage, "pCjDrB5eAEc7JIWVcswkb23qp+k=", false, function() {
    return [
...
//# sourceMappingURL=src_c859136a._.js.map